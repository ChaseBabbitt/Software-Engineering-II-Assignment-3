package com.chasebabbitt.cardgame.cards.hex;

import java.util.Random;

import com.chasebabbitt.cardgame.cards.Card;
import com.chasebabbitt.cardgame.cards.CardFactory;
import com.chasebabbitt.cardgame.cards.hex.concretecards.BlasphemousHorror;
import com.chasebabbitt.cardgame.cards.hex.concretecards.CrushDecoration;
import com.chasebabbitt.cardgame.cards.hex.concretecards.DireSpider;
import com.chasebabbitt.cardgame.cards.hex.concretecards.DuskwingMaiden;
import com.chasebabbitt.cardgame.cards.hex.concretecards.FlyingDecoration;
import com.chasebabbitt.cardgame.cards.hex.concretecards.Llama;
import com.chasebabbitt.cardgame.cards.hex.concretecards.PaladinOfNagaan;
import com.chasebabbitt.cardgame.cards.hex.concretecards.Phantom;
import com.chasebabbitt.cardgame.cards.hex.concretecards.Rhinoceros;
import com.chasebabbitt.cardgame.cards.hex.concretecards.RigidBuffalo;
import com.chasebabbitt.cardgame.cards.hex.concretecards.RisenLancer;
import com.chasebabbitt.cardgame.cards.hex.concretecards.RotrootEnchanter;
import com.chasebabbitt.cardgame.cards.hex.concretecards.RottingBuffalo;
import com.chasebabbitt.cardgame.cards.hex.concretecards.SkyguardDecoration;
import com.chasebabbitt.cardgame.cards.hex.concretecards.Smashodon;
import com.chasebabbitt.cardgame.cards.hex.concretecards.SpearcliffPegasus;
import com.chasebabbitt.cardgame.cards.hex.concretecards.StalwartSpirit;
import com.chasebabbitt.cardgame.cards.hex.concretecards.StartouchedBrave;
import com.chasebabbitt.cardgame.cards.hex.concretecards.SteadfastDecoration;
import com.chasebabbitt.cardgame.cards.hex.concretecards.SterlingSkywatcher;
import com.chasebabbitt.cardgame.cards.hex.concretecards.TrottingBuffalo;
import com.chasebabbitt.cardgame.cards.hex.concretecards.TyrannosaurusHex;
import com.chasebabbitt.cardgame.cards.hex.concretecards.VineTrap;
import com.chasebabbitt.cardgame.cards.hex.concretecards.WildChild;
import com.chasebabbitt.cardgame.cards.hex.concretecards.Zombie;
import com.chasebabbitt.cardgame.cards.hex.concretecards.ZombieVulture;



public class HexCardFactory implements CardFactory {
